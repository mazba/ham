            ...
            <div class="portlet-body">
                <div class="table-scrollable">
                    <table class="table table-bordered table-hover">
                                    ...
                                    <td><?= h($supplierDealingDetail->deal_attach_file) ?></td>
                                </tr>
                                                                                                        <tr>
                                    ...
                                    <td><?= h($supplierDealingDetail->deal_remarks) ?></td>
                                                            ...
                                                            <tr>
                                    <th><?= __('Deal Type Id') ?></th>
                                    <td><?= $this->Number->format($supplierDealingDetail->deal_type_id) ?></td>
                                </tr>
                                                    
                                                            <tr>
                                    <th><?= __('Deal Start Date') ?></th>
                                    <td><?= $this->Number->format($supplierDealingDetail->deal_start_date) ?></td>
                                </tr>
                                                    
                                                            <tr>
                                    <th><?= __('Deal End Date') ?></th>
                                    <td><?= $this->Number->format($supplierDealingDetail->deal_end_date) ?></td>
                                </tr>
                                    ...
                                    <td><?= $this->Number->format($supplierDealingDetail->final_billing_date) ?></td>
                                </tr>
                                                    
                                                            <tr>
                                    <th><?= __('Actual Final Billing Date') ?></th>
                                    <td><?= $this->Number->format($supplierDealingDetail->actual_final_billing_date) ?></td>
                                </tr>
