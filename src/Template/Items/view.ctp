                ...
                <div class="table-scrollable">
                    <table class="table table-bordered table-hover">
                        <tr>
                            ...
                            <td><?= $item->has('parent_item') ? $this->Html->link($item->parent_item->title_bn, ['controller' => 'Items', 'action' => 'view', $item->parent_item->id]) : '' ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?= $item->has('office_warehouse') ? $this->Html->link($item->office_warehouse->title_bn, ['controller' => 'OfficeWarehouses', 'action' => 'view', $item->office_warehouse->id]) : '' ?></td>
                        </tr>
                        <tr>
                            <th><?= __('Title Bn') ?></th>
                        ...
                        <tr>
                            ...
                            <td><?= $item->formatted_purchase_order_date ?></td>
                        </tr>

                        <tr>
                            <th><?= __('Office Receive Date') ?></th>
                            <td><?= $item->formatted_office_receive_date ?></td>
                        </tr>

                        <tr>
                            <th><?= __('Warranty Start Date') ?></th>
                            <td><?= $item->formatted_warranty_start_date ?></td>
                        </tr>

                        <tr>
                            <th><?= __('Warranty End Date') ?></th>
                            <td><?= $item->formatted_warranty_end_date ?></td>
                        </tr>
